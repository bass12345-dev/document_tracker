...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 12, 2022 at 07:34 AM
...
INSERT INTO `documents` (`document_id`, `tracking_number`, `u_id`, `doc_type`, `qr_code`, `created`) VALUES
(1, '258475329', 12, 2, 'QR-1908975950.png', '2022-04-12 05:38:02');
...
(1, 258475329, 4, 2, 12, 1, 12, 1, 'received', 1, '2022-04-12 05:38:03', 1, '2022-04-12 05:38:03', ''),
(2, 258475329, 5, 2, 12, 1, 11, 3, 'received', 1, '2022-04-12 05:39:20', 1, '2022-04-12 05:38:24', ''),
(3, 258475329, 6, 2, 11, 3, 12, 1, 'completed', 1, '2022-04-12 05:41:54', 0, '2022-04-12 05:40:56', '');
...
--
ALTER TABLE `flow`
  MODIFY `flow_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
