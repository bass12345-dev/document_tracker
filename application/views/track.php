                                                    ...
                                                    <div class="page-header-content">
                                                        <div class="row align-items-center justify-content-between pt-3">
                                                            ...
                                                            <div class="col-12 col-xl-auto mb-3">
                                                                  ...
                                                                  <a class="btn btn-sm btn-light text-primary add-department p-3 rounded-pill"   style="font-size: 15px" href="<?php echo base_url() ?>login">
                                    ...
                                    html += '<div class="timeline-item-marker">\
                                        ...
                                        if (data[count].status == 'hold') {
                                             ...
                                             html += '<div class="timeline-item-content">\
                                                <span>Document <a href="">#'+data[count].tracking_code+'</a> is on hold in the '+data[count].department_name+'</span>  \
                                             ...
                                             html += '<div class="timeline-item-content">\
                                                <span>Document <a href="">#'+data[count].tracking_code+'</a> is in the '+data[count].department_name+'</span>  \
